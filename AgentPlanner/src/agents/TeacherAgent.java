...
public class TeacherAgent extends Agent {
    ...
    private ArrayList<String> okGroups;
    ...
    public void takePlace(int day, int time, int roomNo, String group) {
        mySchedule.setRoomerIn(day, time, roomNo, group);
        okGroups.add(group);
    }
...
//        System.out.println();
    ...
    public void addToOkGroups(String group) {
        this.okGroups.add(group);
    }
    
    public void foo() {
        System.out.println(getLocalName() + " : " + teacher.toString());
//        for(Group group : myGroups) {
//            System.out.println(getLocalName() + " : " + group.toString());
//        }
    }
}
